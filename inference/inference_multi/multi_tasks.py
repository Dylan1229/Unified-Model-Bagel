...
# Removed printer import as it wasn't provided, used standard print instead
# If you have printer.py, uncomment the original import.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--parallel_mode", type=str, default=ParallelMode.DP)
...
def prepare_output_dir(output_path: Path, rank: int, distributed: bool) -> Path:
    """Creates output directory. In distributed mode, avoids race conditions."""
